...
// //         return`Thi is a ${this.Name} ${this.model} ${this.year} model, going for $${this.price}`;
// // }
// // }
// // console.log(Cars.description());

// // const sentence= "welcome to alabian soloutions "
// // console.log(sentence.slice(11, -1));
// // let num1 = 3
// // let num2 = 7
// // let num3 = num1.toString() + num2.toString()
// // console.log(num3);

// const Polygons = ["Pentagon", "Hexagon", "Heptagon", "Octagon", "Nonagon", "Decagon"]
// const Triangles = ["Acute", "isosceles", "scalene"]
// console.log(Triangles.concat(Polygons));


let original =[2,4,5,6,3,8]
let givennum = 7
let givennum2 = 3
if(original.includes(givennum)){
console.log(true);
}
else{
    console.log(false);
}
if(original.includes(givennum2)){
    console.log(true);
    }
    else{
        console.log(false);
